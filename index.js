...
client.once('ready', () => {
    ...
    client.user.setActivity(`${client.user.username.toUpperCase()}`, { type: "LISTENING" }); // Set the bot's activity status
...
client.on('message', (message) => {
	...
	if (config.command.notfound_message === true && !client.commands.has(command)) {
        return message.channel.send(
            ...
            .setDescription(`Üzgünüm ama \`${command}\` komutunu bulamıyorum!`)
